...
| `SEARCH_CLIENT_TYPE` | `SEARCH_ENGINE` | Search engine type: `elasticsearch` or `opensearch` |
...
See [Introspection API](../usage/04-introspection.md) for the full response schema.
