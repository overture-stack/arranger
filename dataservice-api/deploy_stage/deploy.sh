...
if [ $1 = "dev" ]; then
  ...
  terraform validate -var 'image=538745987955.dkr.ecr.us-east-1.amazonaws.com/kf-api-arrangerservice:latest' \
   -var 'task_role_arn="arn:aws:iam::538745987955:role/kfArrangerserviceApiRole-dev"' -var 'application=arrangerservice-api' \
...
if [ $1 = "qa" ]; then
  ...
  terraform validate -var 'image=538745987955.dkr.ecr.us-east-1.amazonaws.com/kf-api-arrangerservice:latest' \
   -var 'task_role_arn="arn:aws:iam::538745987955:role/kfArrangerserviceApiRole-qa"' -var 'application=arrangerservice-api' \
