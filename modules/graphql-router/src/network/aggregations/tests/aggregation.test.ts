...
// 			jest.resetModules();
// 		});
// 		test.todo('should resolve multiple Aggregations type fields', () => {
...
// 		test.todo('should resolve multiple NumericAggregations type fields', () => {
// 			jest.mock('../../index', () => ({
...
// 		test.todo('should resolve a combination of Aggregations and NumericAggregations type fields', () => {
// 			jest.mock('../../index', () => ({
