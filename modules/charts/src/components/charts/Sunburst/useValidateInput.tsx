...
export type ValidationInput = {
	fieldNames: [string, string]; // Multiple fields for hierarchy
};
 ...
 *
 * @param { fieldNames } - Array of GraphQL field names to validate
 * @returns Valid chart aggregation configuration or null if validation fails
 */
export const useValidateInput = ({ fieldNames }: ValidationInput): ChartConfig | null => {
	...
	// valid
	return { fieldNames, gqlTypenames: [aggregationsTypenames.Aggregations] };
};
