...
import { Arranger, Aggregations, SQONViewer, Table } from '#index.js';
import State from '#State.js';
import { StyleProvider, AVAILABLE_THEMES } from '#ThemeSwitcher/index.js';
import { ACTIVE_INDEX, DOCUMENT_TYPE, deleteValue } from '#utils/config.js';
...
const DemoHeader = ({ update }) => {
	return (
		<div
			...
			`}
		>
			{process.env.STORYBOOK_PORTAL_NAME || process.env.STORYBOOK_PORTAL_NAME || 'Data Portal'} Search Page
			<div
				css={`
					margin-left: auto;
					cursor: pointer;
